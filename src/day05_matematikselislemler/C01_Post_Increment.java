...
public class C01_Post_Increment {
    ...
    public static void main(String[] args) {
        ...
        sadece ++ ve -- islemi icin sayidan sonra veya once yazilmasina gore farkli iki isleyis olur


         */

        int sayi3= sayi2++;// 1- sayi2 bir arttirilicak
                           // 2-sayi 2 degeri ,sayi3'e atanacak

        /*
          ++ veya -- variable'dan sonra olursa buna post....
          bu durumda o satirda yapilan iki islemden
          artirma veya azaltma islemi yapar
         */
