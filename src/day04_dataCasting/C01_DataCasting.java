...
public class C01_DataCasting {
    ...
    public static void main(String[] args) {
        ...
        char yeniHarf = (char)(harf+1);  // kod bu durumda once sagdaki islemi yapar
                                 ...
                                 //char bir variable 98 olmayacagi icin java hata verir
       ...
       /*
           ...
           Java eger bu degr atamasinda sorun olusacagini
           (data kayiplarin olusabilecegi  veya datanin baskalasabilecegi) gorurse
