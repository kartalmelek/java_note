...
public class C01_AsciiTable {
    public static void main(String[] args) {
        ...
        /*
        1- char data turu isleme girdigi degiskenin turune gore farkli davranabilir eger matematiksel
           isleme girdigi variable sayisal bir degerse sayi gibi davranir
